              ...
              // effacer le contenu de la div "Seance"
                        ...
                        socket.on('seance_list', function(data) {
                          ...
                          $.each(seances, function(index, seance) {
                            const parts = seance.date.split('-'); // sépare la date en parties: année, mois, jour
                            const formattedDate = `${parts[2]}/${parts[1]}/${parts[0]}`; // construit la date formatée
                            if (seance.idFilm == Film && seance.idCinema == cinemaId && formattedDate == selectBox.value) {
                              if(bool == 0)
                              {
                                evenementDiv.innerHTML = `
                                            ...
                                            <div class="u-layout-col">
                                              <div class="u-container-style u-layout-cell u-palette-1-base u-size-60 u-layout-cell-1">
                                                <div class="u-container-layout u-container-layout-1">
                                                  ...
                                                  <div class="u-container-style u-group u-palette-2-base u-shape-rectangle u-group-` + NombreSeance + `"><div class="u-container-layout u-container-layout-2"><p class="u-align-center u-text u-text-2"><a href="../paiement/paiement.php?film_id=` + filmId + `&salle=` + seance.idSalle + `&id=`+ cinemaId + `&id_seance=` + seance.idSeance + `">` + seance.horraireDebut + `</a></p></div></div>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
